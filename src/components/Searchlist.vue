    ...
    <div id="container">
        <div class="sidebar">
            ...
            <a href="http://www.w3cplus.com/" target="_blank" class="partnersAd">
                <img src="../assets/images/w3cplus.png" width="230" height="80" alt="w3cplus" />
            </a>
            <a href="" target="_blank" class="partnersAd">
                <img src="../assets/images/jquery_school.jpg" width="230" height="80" alt="JQ学校" />
            </a>
            <a href="http://linux.cn/" target="_blank" class="partnersAd">
                <img src="../assets/images/linuxcn.png" width="230" height="80" alt="Linux中文社区" />
            </a>
            <a href="http://zt.zhubajie.com/zt/makesite? utm_source=lagou.com&utm_medium=referral&utm_campaign=BD-yl" target="_blank"
                class="partnersAd">
                <img src="../assets/images/zhubajie.jpg" width="230" height="80" alt="猪八戒" />
            </a>
            <a href="http://www.imooc.com" target="_blank" class="partnersAd">
                <img src="../assets/images/muke.jpg" width="230" height="80" alt="幕课网" />
            </a>
          ...
          render(createElement) {
              return createElement(
                  'script',
                  {
                      attrs: {
                          type: 'text/javascript',
                          src: '../../static/js/searchlist.pager.js'
                      }
                  }
              )
          }
